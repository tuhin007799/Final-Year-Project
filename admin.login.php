    ...
    <section class="container-fluid login">
        <div class="row justify-content-center">
            <div class="col-sm-4 col-md-5 col-lg-4 col-xl-4 mx-5 my-5 text-secondary">
                <h1 class="text-center text-info font-weight-bold text-uppercase">ADMIN SIGN IN</h1>
...
?>
                ...
                <form action="admin.login.php" method="POST" class="needs-validation" novalidate>
                    ...
                    <button type="submit" name="submit" class="btn btn-info btn-block font-weight-bold">Sign In</button>
                </form>
                <div class="row py-2">
                    <div class="col text-center">
                        <a class="text-important font-weight-bold" href="admin.forgot.php">Forgot Password?</a>
                    </div>
                </div>
            </div>
        </div>
