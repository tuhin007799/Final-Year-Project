        ...
        <div id="content">
            ...
            <div class="container-fluid py-1 px-1">
                ...
                <div class="row justify-content-end mx-5">
                    <a class="btn btn-outline-secondary btn-sm" href="add.lecture.php"><i class="fas fa-plus"></i> ADD LECTURE</a>
                </div>
                ...
                <div class="row justify-content-center">
                    ...
                    if(isset($_GET['lecture_id'])){
                         ...
                         $lecture = new Lecture();
                        if ($lecture->delete_lecture("lecture",$lecture_id)==true) {
                ...
                <div class="row justify-content-center" id="course">
                    ...
                    <?php 
                    $lecture = new Lecture();
                    $data = $lecture->select_lecture_by_course('lecture',$_SESSION["course_id"]);
                    if(empty($data)){
                        echo "<div class='text-center alert alert-warning alert-dismissible fade show' role='alert'>".
                    ...
                    <div class="col-lg-3 text-justify mx-2 my-2 px-0">
                        ...
                        <a class="btn btn-sm btn-outline-danger" href="admin.lecture.view.php?lecture_id=<?php echo $value['lecture_id'];?>"><i class="fas fa-trash-alt"></i> Delete</a>
                        <a class="btn btn-sm btn-outline-info my-2" href="update.lecture.php?lecture_id=<?php echo $value['lecture_id'];?>"><i class='fas fa-edit'></i> Edit</a>

                        <div id="sem">
                        <span id="video_btn"><i class='far fa-play-circle' style='font-size:50px;color:#DC143C'></i></span>
                        <a class="image" href="admin.topic.view.php?lecture_id=<?php echo $value['lecture_id']; ?>">
