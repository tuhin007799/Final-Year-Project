    ...
    <div id="content">
      ...
      <div class="container-fluid my-3">
            <div class="row justify-content-center">
                ...
                <h4 class="text-secondary text-center"><strong><i class="fas fa-edit"></i> ANSWER</strong></h4>
                <?php
                $db = new Database();
                ...
                if(isset($_POST['submit'])){
                   ...
                   // echo $user_reply;
                    ...
                    $sql = "INSERT INTO reply (u_name,user_reply,reply_by,date_and_time,question_id) VALUES ('$name','$user_reply','$email','$date','$question_id')";
                    if ($conn->query($sql)) {
                      echo "<div class='text-center alert alert-success alert-dismissible fade show' role='alert'>".
                           "<strong>Added success!</strong> Answer uploaded.".
                ...
                <?php
                $qs = new Question();
                $data = $qs->get_question_by_id("question",$_SESSION["question_id"]);
                foreach($data as $key => $value){
                ?>
                <h3 class="text-left font-weight-bold">Posted by <span class="text-capitalize text-danger font-italic"><?php echo $value["u_name"]; ?></span> <small><span class="text-muted font-italic">on <?php echo $value["date_and_time"]; ?></span></small></h3>
                <div>
                    <strong>Question: </strong><?php echo $value["user_question"]; ?>
                </div>
                <?php
                }
                ?>
                    <form action="reply.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                        ...
                        <div class="form-group">
                            <label for="user_reply">
                            <strong><i class="fas fa-edit"></i> Enter Answer:</strong>
                            </label>
                            <textarea type="text" class="" id="user_reply" name="user_reply" required></textarea>
                            <div class="valid-feedback">Valid.</div>
                            <div class="invalid-feedback">Please fill out this field.</div>
                        </div>
                        <div class="row">
                            <div class="col text-center">
                            <button type="submit" name="submit" class="btn btn-info"><i class="fas fa-edit"></i><strong>Post your answer</strong></button>
                            </div>
                        </div>
                    </form>
                </div>    
