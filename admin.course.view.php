...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h4 class="text-center text-secondary text-uppercase py-2"><strong>courses</strong></h4>

            <div class="container-fluid py-1 px-1">

                <div class="row justify-content-end mx-5">
                    <a class="btn btn-outline-secondary btn-sm" href="add.course.php"><i class="fas fa-plus"></i> ADD COURSE</a>
                </div>
                 ...
                 <div class="row justify-content-center">
                    ...
                    if(isset($_GET['course_id'])){
                         ...
                         $course = new Course();
                        if ($course->delete_course("course",$course_id)==true) {
                ...
                <div class="row justify-content-center" id="course">
                    ...
                    <?php 
                    $course = new Course();
                    $data = $course->select_course_by_semester('course',$_SESSION["sem_id"]);
                    if(empty($data)){
                        echo "<div class='text-center alert alert-warning alert-dismissible fade show' role='alert'>".
                    ...
                    <div class="col-lg-3 text-justify mx-2 my-2 px-0">

                        <a class="btn btn-sm btn-outline-danger" href="admin.course.view.php?course_id=<?php echo $value['course_id'];?>"><i class="fas fa-trash-alt"></i> Delete</a>
                        <a class="btn btn-sm btn-outline-info my-2" href="update.course.php?course_id=<?php echo $value['course_id'];?>"><i class='fas fa-edit'></i> Edit</a>

                        <div id="sem">

                        <span id="video_btn"><i class='far fa-play-circle' style='font-size:50px;color:#DC143C'></i></span>
                        <a class="image" href="admin.lecture.view.php?course_id=<?php echo $value['course_id'];?>">
                            <?php $image_src = "images/courses/".$value['course_image']; ?>
                            <img class="mx-0 px-0" src="<?php echo $image_src; ?>" alt="course image" height="150" width="100%">
                            <h5 class="text-capitalize text-secondary text-center py-2"><i class='fas fa-book'></i> <?php echo $value['course_code']."-".$value['course_title']; ?></h5>
                            <h5 class="text-secondary text-center"><i class="fa fa-file"></i> 
                                <?php 

                                $lecture = new Lecture();
                                $lecture_quantity = $lecture->select_lecture_by_course("lecture",$value["course_id"]);
                                if (!empty($lecture_quantity)) {
                                    echo "Total ".count($lecture_quantity)." lectures";
                                }else{
                                    echo "Total 0 lectures";
                                }
                            ...
                            <div class="overlay">
                               <div class="text text-uppercase"><i class='fas fa-book' style="font-size:50px;color:#DC143C"></i> <br>
                                <span class="text-white"><?php echo $value['course_title']; ?></span></div>
                            </div>
                        </a>
                    </div>
