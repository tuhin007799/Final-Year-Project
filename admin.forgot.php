...
if (isset($_POST['submit'])) {
    ...
    if ($data == "register") {
        ...
        if ($user->update_user("admin", $data, $email) == true) {
            $to = $email;
            ...
            if (mail($to, $subject, $message, $headers)) {
                echo "<div class='text-center alert alert-success alert-dismissible fade show' role='alert'>" .
                    "<strong>E-mail Sent!</strong> Please check your mail. Click for " . "<a href='admin.login.php' class='alert-link'>login.</a>" .
                ...
                echo "<div class='text-center alert alert-danger alert-dismissible fade show' role='alert'>" .
                    "<strong>Update Failed!</strong> Contract with easySEL" .
                    "<button type='button' class='close' data-dismiss='alert' aria-label='Close'>" .
                    "<span aria-hidden='true'>&times;</span>" .
                    "</button>" .
                    "</div>";
...
?>
                <form action="admin.forgot.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
