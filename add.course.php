...
<body>
  ...
  <div class="wrapper">
    ...
    <div id="content">
      ...
      <h4 class="text-center text-secondary py-2 text-uppercase"><strong>Add course</strong></h4>
    ...
    if (is_numeric($lecture_quantity)) {
        ...
        if (!empty($course_description)) {
            ...
            if (in_array($fileType, $allowTypes)) {
                ...
                if ($add_course->add_course("course", $data) == true && move_uploaded_file($_FILES["course_image"]["tmp_name"], $targetFilePath)) {
...
?>
        ...
        <form action="add.course.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="lecture_quantity" placeholder="Enter lecture quantity"
          ...
          <div class="row">
            <div class="col text-center">
              <button type="submit" name="submit" class="btn btn-info"><i class="fas fa-plus"></i> Add Course</button>
            </div>
          </div>
        </form>
