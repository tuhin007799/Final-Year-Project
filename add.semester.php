...
?>
      ...
      <h4 class="text-center text-secondary py-2 text-uppercase"><strong>Add semester</strong></h4>
    ...
    if (is_numeric($course_quantity)) {
        ...
        if (!empty($semester_description)) {
            ...
            if (in_array($fileType, $allowTypes)) {
                ...
                if ($sem->add_semester("semester", $data) == true && move_uploaded_file($_FILES["semester_image"]["tmp_name"], $targetFilePath)) {
                    echo "<div class='text-center alert alert-success alert-dismissible fade show' role='alert'>" .
                        "<strong>Success!</strong>" . " Semester added success." .
...
?>
        ...
        <form action="add.semester.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
          <div class="form-group">
            <label for="semester_title"><strong>Semester Title:</strong></label>
            <input type="text" class="form-control" id="semester_title" placeholder="semester title"
              name="semester_title" required>
            <div class="valid-feedback">Valid.</div>
            <div class="invalid-feedback">Please fill out this field.</div>
          </div>
          <div class="form-group">
            <label for="course_quantity"><strong>Course Quantity:</strong></label>
            <input type="text" class="form-control" id="course_quantity" placeholder="course quantity"
              name="course_quantity" required>
            <div class="valid-feedback">Valid.</div>
            <div class="invalid-feedback">Please fill out this field.</div>
          </div>
          <div class="form-group">
            <label for="semester_description"><strong>Semester Description:</strong></label>
            <textarea type="text" class="form-control" id="semester_description" name="semester_description"
              required></textarea>
            <div class="valid-feedback">Valid.</div>
            <div class="invalid-feedback">Please fill out this field.</div>
          </div>
          <div class="form-group">
            ...
            <input type="file" class="form-control-file" id="semester_image" placeholder="semester profile image"
              name="semester_image" required>
            <div class="valid-feedback">Valid.</div>
            <div class="invalid-feedback">Please fill out this field.</div>
          </div>
          ...
          <div class="row">
            <div class="col text-center">
              <button type="submit" name="submit" class="btn btn-info"><i class="fas fa-plus"></i> Add Semester</button>
            </div>
          </div>
        </form>
