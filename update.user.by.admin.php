    ...
    <div class="wrapper">
        ...
        <div id="content">
             ...
             $password = $db->escape($_POST['password']);
                        ...
                        if(in_array($fileType, $allowTypes)){
                                if(move_uploaded_file($_FILES["profile_picture"]["tmp_name"], $targetFilePath)){
                                    ...
                                    if ($user->update_user("user",$data,$_SESSION["user"])==true) {
          ...
          ?>
                         <?php
                        $user = new USER();
                        $data = $user->specific_user("user",$_SESSION["user"]);
                        if (!empty($data)) {
                        ...
                        <form action="update.user.by.admin.php" name="RegForm" onsubmit="return validate()" method="POST"
                    enctype="multipart/form-data" class="needs-validation" novalidate>
                    <div class="form-row">
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            <label for="inputEmail"><strong>Email:</strong></label>
                            <input type="email" name="email" value = "<?php if(isset($_SESSION['user'])) echo $_SESSION['user']; ?>" class="form-control" id="inputEmail"
                        ...
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            ...
                            <input type="password" name="password" value = "<?php if(isset($_SESSION['password'])) echo $_SESSION['password']; ?>" class="form-control" id="inputPassword"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" value = "<?php if(isset($_SESSION['name'])) echo $_SESSION['name']; ?>" class="form-control" id="inputName" placeholder="Full Name.."
                            required>
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">Please fill out this field.</div>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="address" value = "<?php if(isset($_SESSION['address'])) echo $_SESSION['address']; ?>" class="form-control" id="inputAddress"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-5">
                            ...
                            <input type="text" name="phone" value = "<?php if(isset($_SESSION['phone'])) echo $_SESSION['phone']; ?>" class="form-control" id="inputPhone"
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="study_session" value = "<?php if(isset($_SESSION['study_session'])) echo $_SESSION['study_session']; ?>" class="form-control" id="inputSession"
                    ...
                    <div class="form-group">
                        ...
                        <input type="submit" name="user_profile_update" class="btn btn-info btn-block" value="UPDATE">
                </form>
